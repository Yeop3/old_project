        ...
        <b-overlay :show="loading" rounded="sm" no-center>
          ...
          <div class="table-responsive">
            ...
            >
              ...
              <template v-slot:cell(easy_pay_wallet)="data">
                <router-link :to="`/global-money/wallet/show/${data.item.order.number}`">
                  {{ (data.item.easy_pay_wallet.name) }}
                </router-link>
              </template>
              ...
              <template v-slot:cell(actions)="data">
                <router-link :to="`/easy-pay/transaction/show/${data.item.number}`" class="btn btn-primary btn-xs">
