...
use App\Bot\Conversations\ProcessHotOrderConversation;
use App\Models\Bot;
...
/**
 * Class DriverProcessHotOrderHandler.
 */
final class DriverProcessHotOrderHandler implements BotHandler
{
    ...
    public function execute(BotMan $botMan, Bot $botModel, ?string ...$params): void
    {
        ...
        $botMan->startConversation(
            new ProcessHotOrderConversation($this->checker, $order, $driver),
