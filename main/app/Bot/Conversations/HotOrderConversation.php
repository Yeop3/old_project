...
use App\Services\Order\CreateHotOrderDto;
...
/**
 * Class HotOrderConversation.
 */
final class HotOrderConversation extends Conversation
{
    public stdClass                 $values;
    public ?Client                  $client = null;
    public ?ProductType             $productType = null;
    public ?Location                $location = null;
    public ?CreateHotOrderCommand   $createHotOrderCommand = null;
    public ?Bot                     $botModel = null;
    public ?BotLogicCommand         $logicCommand = null;
    ...
    private function askAgreeWithPrice(): void
    {
        ...
        [, , , $totalPrice] = $this->createHotOrderCommand->getOrderCalculator()
    ...
    {
        $paymentMethods = $this->createHotOrderCommand->getPaymentMethods($this->client, $this->productType);
    ...
    {
        try {
            $order = $this->createHotOrderCommand->execute(
                $this->client,
                new CreateHotOrderDto(
                    $this->productType,
                    $this->location,
                    $paymentMethod,
