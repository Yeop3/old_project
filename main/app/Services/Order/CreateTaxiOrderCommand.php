...
/**
 * Class CreateTaxiOrderCommand.
 */
final class CreateTaxiOrderCommand
{
    ...
    public function execute(Client $client, CreateTaxiOrderDto $dto): Order
    {
        ...
        $product->delivery_type = DeliveryType::taxi();
        $product->delivery_address = $dto->getAddress();
