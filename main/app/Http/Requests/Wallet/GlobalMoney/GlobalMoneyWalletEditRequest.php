...
use App\Models\User;
use App\Services\Wallet\GlobalMoney\Edit\GlobalMoneyWalletEditDto;
use App\Services\Wallet\GlobalMoney\VO\GlobalMoneyLoginData;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

/**
 * Class GlobalMoneyWalletEditRequest.
 */
class GlobalMoneyWalletEditRequest extends FormRequest
{
    /**
    ...
    public function getDto(): GlobalMoneyWalletEditDto
    {
        return new GlobalMoneyWalletEditDto(
